...
class BERTClassifier(nn.Module):
    def __init__(self, trg_vocab_size):
        ...
        self.bert_relu = nn.Sequential(nn.Linear(768, 768), nn.ReLU())
        self.bert_final = nn.Linear(768, trg_vocab_size)

    def forward(self, input):
        seq_feats, cls_feat = self.bert(input)
        return self.bert_final(self.bert_relu(cls_feat))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pred_fn', type=str, default='../data/tw_mm_s1/{}_bertweet.pt', help='')
